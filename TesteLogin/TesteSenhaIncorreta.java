...
public class TesteSenhaIncorreta {
	...
	public void test() throws IOException {
		...
		driver.findElement(By.name("session_password")).sendKeys("ttttttttttttt");
		driver.findElement(By.cssSelector("button.btn__primary--large.from__button--floating")).click();
		
		//Screenshot
				TakesScreenshot ts=(TakesScreenshot)driver;
				File source =ts.getScreenshotAs(OutputType.FILE);
				FileUtils.copyFile(source, new File("./Screenshot/LinkedInSenhaIncorreta.png"+getDate()));
