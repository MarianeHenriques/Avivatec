...
public class TesteSenha{
	...
	public void test() throws IOException {
		...
		String erro = driver.findElement(By.id("error-for-password")).getText();
		
		Assert.assertEquals("Insira uma senha.", erro);
		
		//Screenshot
				TakesScreenshot ts=(TakesScreenshot)driver;
				File source =ts.getScreenshotAs(OutputType.FILE);
				FileUtils.copyFile(source, new File("./Screenshot/LinkedInSenhaIncorreto.png"+getDate()));
